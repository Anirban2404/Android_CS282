...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // button to ipload images
        btnUploadPic = (Button) findViewById(R.id.buttonUploadPic);
        ...
        final ArrayList<String> imageList = myList;
        /**
         * Upload images button click event
         */
        btnUploadPic.setOnClickListener(new View.OnClickListener() {

            // launching the upload activity
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this, UploadActivity.class);
                i.putExtra("filePath", imageList);
                startActivity(i);
            }
        });
