...
public class DownloadContentProvider extends ContentProvider
{
	...
	private static final String AUTHORITY = "com.anirban.contentprovider";
	...
	public int update(Uri uri, ContentValues values, String selection,
	    ...
	    switch (uriType) {
	    case IMAGE:
	      rowsUpdated = sqlDB.update(IMAGE_Table.TABLE_IMAGE, 
	          values, 
	          selection,
	          selectionArgs);
	      break;
